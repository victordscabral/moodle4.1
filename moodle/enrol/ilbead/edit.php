...
require_capability('enrol/ilbead:config', $context);

$PAGE->set_url('/enrol/ilbead/edit.php', array('courseid'=>$course->id, 'id'=>$instanceid));
...
/** @var enrol_ilbead_plugin $plugin */
...
$mform = new enrol_ilbead_edit_form(NULL, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_ilbead'));

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_ilbead'));
$mform->display();
echo $OUTPUT->footer();
