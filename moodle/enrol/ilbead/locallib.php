...
class enrol_ilbead_enrol_form extends moodleform {
    protected $instance;
    protected $toomany = false;

    /**
     * Overriding this function to get unique form id for multiple ilbead enrolments.
     *
    ...
    public function definition() {
        ...
        if ($instance->customint3 > 0) {
            ...
            if ($count >= $instance->customint3) {
                // Bad luck, no more ilbead enrolments here.
                $this->toomany = true;
                $mform->addElement('static', 'notice', '', get_string('maxenrolledreached', 'enrol_ilbead'));
                return;
            }
        }
        ...
        if ($instance->password) {
            ...
            $mform->addElement('static', 'nokey', '', get_string('nopassword', 'enrol_ilbead'));
        }

        $this->add_action_buttons(false, get_string('enrolme', 'enrol_ilbead'));
            ...
            if ($data['enrolpassword'] !== $instance->password) {
                if ($instance->customint1) {
                    ...
                    if (!$found) {
                        ...
                        $errors['enrolpassword'] = get_string('passwordinvalid', 'enrol_ilbead');
                    }
                    ...
                    if ($plugin->get_config('showhint')) {
                        ...
                        $errors['enrolpassword'] = get_string('passwordinvalidhint', 'enrol_ilbead', $hint);
                    } else {
                        $errors['enrolpassword'] = get_string('passwordinvalid', 'enrol_ilbead');
                    }
                }
