...
/**
 * Self enrolment plugin - support for user ilbead unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'ilbead'), '*', MUST_EXIST);
...
if (!$plugin->get_unenrolilbead_link($instance)) {
    redirect(new moodle_url('/course/view.php', array('id'=>$course->id)));
}

$PAGE->set_url('/enrol/ilbead/unenrolilbead.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolilbeadconfirm', 'enrol_ilbead', format_string($course->fullname));
