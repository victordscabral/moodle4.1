...
class enrol_ilbead_plugin extends enrol_plugin {
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        if ($instance->customint5) {
            ...
            if (!cohort_is_member($instance->customint5, $USER->id)) {
                ...
                return $OUTPUT->box(markdown_to_html(get_string('cohortnonmemberinfo', 'enrol_ilbead', $a)));
            }
        }
        ...
        $form = new enrol_ilbead_enrol_form(NULL, $instance);
    ...
    public function sync(progress_trace $trace, $courseid = null) {
        ...
        $sql = "SELECT e.*, ue.userid
                  ...
                  JOIN {enrol} e ON (e.id = ue.enrolid AND e.enrol = 'ilbead' AND e.customint2 > 0)
