...
$string['pluginname'] = 'ILB/EAD self enrolment';
$string['pluginname_desc'] = 'The ilbead enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['ilbead:config'] = 'Configure ILB EAD self enrol instances';
$string['ilbead:manage'] = 'Manage enrolled users';
$string['ilbead:unenrol'] = 'Unenrol users from course';
$string['ilbead:unenrolilbead'] = 'Unenrol self from the course';
...
$string['unenrolilbeadconfirm'] = 'Do you really want to unenrol yourself from course "{$a}"?';
