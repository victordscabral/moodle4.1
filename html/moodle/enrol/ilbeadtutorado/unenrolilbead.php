...
/**
 * Self enrolment plugin - support for user ilbeadtutorado unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'ilbeadtutorado'), '*', MUST_EXIST);
...
if (!$plugin->get_unenrolilbeadtutorado_link($instance)) {
    redirect(new moodle_url('/course/view.php', array('id'=>$course->id)));
}

$PAGE->set_url('/enrol/ilbeadtutorado/unenrolilbeadtutorado.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolilbeadtutoradoconfirm', 'enrol_ilbeadtutorado', format_string($course->fullname));
