...
$capabilities = array(
    ...
    /* Add or edit enrol-ilbeadtutorado instance in course. */
    'enrol/ilbeadtutorado:config' => array(
    ...
    'enrol/ilbeadtutorado:manage' => array(
    ...
    'enrol/ilbeadtutorado:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'enrol/ilbeadtutorado:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
