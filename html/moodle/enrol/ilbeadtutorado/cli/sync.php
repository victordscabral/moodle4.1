...
Example:
\$ sudo -u www-data /usr/bin/php enrol/ilbeadtutorado/cli/sync.php
";
    die;
}

if (!enrol_is_enabled('ilbeadtutorado')) {
    cli_error('enrol_ilbeadtutorado plugin is disabled, synchronisation stopped', 2);
}
...
/** @var $plugin enrol_ilbeadtutorado_plugin */
