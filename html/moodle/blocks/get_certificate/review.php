...
$PAGE->set_url('/blocks/get_certificate/review.php', array('id' => $cm->id));
...
$reviewurl = new moodle_url('/blocks/get_certificate/review.php', array('id' => $cm->id));
...
$link = new moodle_url('/blocks/get_certificate/review.php?id='.$cm->id.'&action=get');
