...
function theme_moove_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    ...
    if ($context->contextlevel == CONTEXT_SYSTEM && $filearea === 'marketing7icon') {
        return $theme->setting_file_serve('marketing7icon', $args, $forcedownload, $options);
    }

    if ($context->contextlevel == CONTEXT_SYSTEM && $filearea === 'marketing8icon') {
        return $theme->setting_file_serve('marketing8icon', $args, $forcedownload, $options);
    }
