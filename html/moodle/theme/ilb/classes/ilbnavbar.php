...
/**
 * Creates a navbar for ilb that allows easy control of the navbar items.
 *
 * @package    theme_ilb
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ilbnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_ilb();
    }

    /**
     * Prepares the navigation nodes for use with ilb.
     */
    protected function prepare_nodes_for_ilb(): void {
        global $PAGE;
    ...
    /**
     * Get all the ilbnavbaritem elements.
     *
     * @return ilbnavbaritem[] ilb navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this ilb navbar
     */
    ...
    /**
     * Remove a ilbnavbaritem from the ilb navbar.
     *
     * @param  string|int $itemkey An identifier for the ilbnavbaritem
     * @param  int|null $itemtype An additional type identifier for the ilbnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the ilbnavbaritem.
     */
