...
// The jQuery module is only used for interacting with Bootstrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in Bootstrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_ilb/drawers:show}
     * @property {String} drawerShown See {@link event:theme_ilb/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_ilb/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_ilb/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_ilb/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_ilb/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_ilb/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_ilb/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_ilb/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_ilb/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_ilb/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_ilb/drawers:hidden',
    };
     ...
     * @returns {module:theme_ilb/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_ilb/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_ilb/drawers:close');
     ...
     *
     * @param {module:theme_ilb/drawers} comparisonInstance
     */
