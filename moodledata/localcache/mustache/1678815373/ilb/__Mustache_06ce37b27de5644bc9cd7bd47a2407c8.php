...
class __Mustache_06ce37b27de5644bc9cd7bd47a2407c8 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_ilb/drawer')) {
            $context->pushBlockContext(array(
                'id' => array($this, 'blockA1bdff011432380781745d4fd335039d'),
...
';
    ...
    public function blockA1bdff011432380781745d4fd335039d($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . 'theme_ilb-drawers-primary';
