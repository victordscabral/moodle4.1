...
class __Mustache_6f07dee3f9818aabf57f97b5a66b4dc8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($partial = $this->mustache->loadPartial('theme_ilb/head')) {
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_ilb/navbar')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        $value = $context->find('courseindex');
        $buffer .= $this->sectionE27178bb08708acd0c63b7e08d1038e5($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionE8edc4d405d9349e6031a9c4d5209763($context, $indent, $value);
...
';
        $value = $context->find('courseindex');
        $buffer .= $this->section675de66948b2347f6ff79fa8d1f7c295($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionB70eaaf85d15933ca603c72ac32d70dd($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            ';
...
';
        $buffer .= $indent . '        </div>
';
        if ($partial = $this->mustache->loadPartial('theme_ilb/footer')) {
            $buffer .= $partial->renderInternal($context, $indent . '        ');
        }
        $buffer .= $indent . '    </div>
';
...
';
        ...
        $buffer .= $this->section1c58510c25bbb7850835b4383290b4c9($context, $indent, $value);
    ...
    private function sectionE27178bb08708acd0c63b7e08d1038e5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
        {{< theme_ilb/drawer }}
            {{$id}}theme_ilb-drawers-courseindex{{/id}}
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        ';
                if ($parent = $this->mustache->loadPartial('theme_ilb/drawer')) {
                    $context->pushBlockContext(array(
                        'id' => array($this, 'blockAee6ef12fb9dcfce40ece6161578e0a9'),
    ...
    private function sectionE8edc4d405d9349e6031a9c4d5209763(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
        {{< theme_ilb/drawer }}
            {{$id}}theme_ilb-drawers-blocks{{/id}}
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_ilb/drawer')) {
                    $context->pushBlockContext(array(
                        'id' => array($this, 'block8d0bb1c2a67c62f21aaa06903d315368'),
    ...
    private function section675de66948b2347f6ff79fa8d1f7c295(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="drawer-toggler drawer-left-toggle open-nav d-print-none">
                        <button
                            ...
                            data-action="toggle"
                            data-target="theme_ilb-drawers-courseindex"
                            data-toggle="tooltip"
...
';
                $buffer .= $indent . '                            data-target="theme_ilb-drawers-courseindex"
';
...
';
    ...
    private function sectionB70eaaf85d15933ca603c72ac32d70dd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="drawer-toggler drawer-right-toggle ml-auto d-print-none">
                        <button
                            ...
                            data-toggler="drawers"
                            data-action="toggle"
                            data-target="theme_ilb-drawers-blocks"
                            data-toggle="tooltip"
                            data-placement="right"
...
';
                $buffer .= $indent . '                            data-action="toggle"
';
                $buffer .= $indent . '                            data-target="theme_ilb-drawers-blocks"
';
                $buffer .= $indent . '                            data-toggle="tooltip"
';
                $buffer .= $indent . '                            data-placement="right"
...
';
    ...
    private function section1c58510c25bbb7850835b4383290b4c9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
require([\'theme_ilb/loader\', \'theme_ilb/drawer\'], function(Loader, Drawer) {
    Drawer.init();
...
';
                $buffer .= $indent . 'require([\'theme_ilb/loader\', \'theme_ilb/drawer\'], function(Loader, Drawer) {
';
...
';
    ...
    public function blockAee6ef12fb9dcfce40ece6161578e0a9($context)
    {
        $indent = $buffer = '';
        $buffer .= 'theme_ilb-drawers-courseindex';
...
';
    ...
    public function block8d0bb1c2a67c62f21aaa06903d315368($context)
    {
        $indent = $buffer = '';
        $buffer .= 'theme_ilb-drawers-blocks';
