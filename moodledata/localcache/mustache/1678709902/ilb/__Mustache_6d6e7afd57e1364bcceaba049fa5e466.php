...
class __Mustache_6d6e7afd57e1364bcceaba049fa5e466 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFa0792c8c39a5c50a2079269505ab897($context, $indent, $value);
    ...
    private function sectionFa0792c8c39a5c50a2079269505ab897(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_ilb/drawers\']);
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_ilb/drawers\']);
';
                $context->pop();
            }
        }
